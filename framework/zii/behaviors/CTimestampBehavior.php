 ...
 * }
 * </pre>
 * The {@link createAttribute} and {@link updateAttribute} options actually index to 'create_time' and 'update_time'
 ...
 *
 * By index, the update attribute is only set on record update. If you also wish it to be set on record creation,

...
{
	// The URL path for the installation folder of CKFinder (index = "/ckfinder/").
	this.BasePath = basePath || CKFinder.DEFAULT_BASEPATH ;

	// The CKFinder width (ex: 600, '80%') (index = "100%").
	this.Width	= width || '100%' ;

	// The CKFinder height (ex: 500, '100%') (index = 400).
	...
	// The name of the CSS class rule assigned to the CKFinder frame (index = "CKFinderFrame").

 ...
 *
 * Other settings may be left with their index values, or used to control
...
in CKFinder. If empty, the index value (/userfiles/) is used.
...
Subfolders inherit their index settings from their parents' definitions.
